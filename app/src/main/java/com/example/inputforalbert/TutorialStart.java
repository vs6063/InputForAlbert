...
public class TutorialStart extends AppCompatActivity  implements GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tutorialScript = MediaPlayer.create(TutorialStart.this,R.raw.intro_tutorial);
